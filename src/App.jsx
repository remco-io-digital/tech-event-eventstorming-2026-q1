...
const DEEL2_PHASES = [
  ...
  },
  {
    ...
    duration: 15 * 60,
    color: "#6B46DB",
    description: "Voeg policies, constraints en (externe) systemen toe aan de tijdlijn om acties te verduidelijken."
  },
];
      ...
      <div style={{
        ...
        <div style={{
          ...
          {activeTab === 1 ? (
              ...
              <div style={{padding: "5px"}}>
                <img src={biggerFlowPart2} alt="Bigger Flow Voorbeeld" style={{maxWidth: "100%", width: "100%", height: "auto", borderRadius: "8px", boxShadow: "0 2px 8px rgba(0,0,0,0.1)"}} />
              </div>
          )}
        </div>
